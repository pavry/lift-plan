<template>
  <div>
    ...
    <label>1RM for Selected Exercise (kg)</label>
  ...
  methods: {
    ...
    calculate() {
      ...
      weeks.forEach(({ week, day1, day2 }) => {
        ...
        result += `Week ${week}:\n`
        result += `  Day 1: ${day1.sets} x ${day1.reps} @ ${day1.percent * 100}% = ${w1} kg\n`
        result += `  Day 2: ${day2.sets} x ${day2.reps} @ ${day2.percent * 100}% = ${w2} kg\n\n`
      })
